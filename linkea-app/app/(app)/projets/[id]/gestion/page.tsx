            ...
            {githubRepo && (
              <div style={{ background: C.surface, borderRadius: 16, boxShadow: "0 2px 12px rgba(0,0,0,0.06)", padding: 20 }}>
                ...
                {commits.length === 0 ? (
                  ...
                  >
                    {commits.slice(0, 8).map((c, cIndex) => (
                      <motion.a
                        key={c.sha}
                        variants={reduceMotion ? undefined : (cIndex < STAGGER_LIMIT ? listItemVariants : listItemVariantsNoStagger)}
                ...
                >
                  {filtered.map((task, taskIndex) => {
                    ...
                    return (
                      <motion.tr
                        key={task.id}
                        variants={reduceMotion ? undefined : (taskIndex < STAGGER_LIMIT ? listItemVariants : listItemVariantsNoStagger)}
