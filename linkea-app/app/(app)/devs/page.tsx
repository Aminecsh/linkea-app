        ...
        >
          {sortedDevs.map((dev, devIndex) => {
            ...
            return (
              <motion.div
                key={dev.id}
                variants={reduceMotion ? undefined : (devIndex < STAGGER_LIMIT ? listItemVariants : listItemVariantsNoStagger)}
                style={{ background: C.surface, border: `1px solid ${C.hairline}`, borderRadius: 20, overflow: "hidden" }}>
