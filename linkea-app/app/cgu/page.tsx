    ...
    <div className="min-h-screen bg-white px-4 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-sm text-slate-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">2. Accès au service</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">3. Rôles utilisateurs</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">4. Comportement attendu</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">5. Contenu utilisateur</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">6. Sanctions</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">7. Responsabilité</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">9. Droit applicable</h2>
          ...
          <section>
            ...
            <p>Pour toute question : <a href="mailto:contact@linkea.fr" className="text-indigo-600 underline">contact@linkea.fr</a></p>
          </section>
