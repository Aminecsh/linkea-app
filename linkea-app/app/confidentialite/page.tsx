  ...
  return (
    <div className="min-h-screen bg-white px-4 py-12">
      <div className="max-w-2xl mx-auto">
        <Link href="/" className="text-sm text-slate-400 hover:text-slate-600 mb-8 inline-block">← Retour</Link>

        <h1 className="text-3xl font-black text-slate-900 mb-2">Politique de confidentialité</h1>
        <p className="text-sm text-slate-400 mb-10">Dernière mise à jour : juin 2026</p>

        <div className="prose prose-slate max-w-none space-y-8 text-sm text-slate-700 leading-relaxed">

          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">1. Qui sommes-nous ?</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">5. Conservation des données</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">6. Partage des données</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">7. Tes droits (RGPD)</h2>
            <p>Tu disposes des droits suivants, exerçables depuis les <Link href="/parametres" className="text-indigo-600 underline">paramètres de ton compte</Link> :</p>
            <ul className="list-disc pl-5 space-y-1">
            ...
            <p className="mt-3">Pour toute demande : <a href="mailto:privacy@linkea.fr" className="text-indigo-600 underline">privacy@linkea.fr</a></p>
          </section>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">9. Sécurité</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3">10. Contact & réclamation</h2>
            <p>Pour toute question : <a href="mailto:privacy@linkea.fr" className="text-indigo-600 underline">privacy@linkea.fr</a></p>
            <p className="mt-2">Tu peux également introduire une réclamation auprès de la <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="text-indigo-600 underline">CNIL</a>.</p>
          </section>

        </div>

        <div className="mt-12 pt-8 border-t border-slate-100 flex gap-4 text-xs text-slate-400">
          <Link href="/cgu" className="hover:text-slate-600">Conditions générales</Link>
          <Link href="/parametres" className="hover:text-slate-600">Mes paramètres</Link>
        </div>
      </div>
    </div>
  );
